"""
Configuration de base pour ASIKO Connect.
...
WSGI_APPLICATION = 'asiko_connect.wsgi.application'
...
AI_MICROSERVICE_TIMEOUT = config('AI_MICROSERVICE_TIMEOUT', default=30, cast=int)
